...
public class Operator05 {
	...
	public static void main(String[] args) {
		...
		// && : AND 연산
		// 좌항과 우항이 모드 true 일 때, true, 아니면 false
		int num1 = 8;
		int num2 = 5;
		...
		// || : OR 연산
		// 좌항과 우항 중 하나라도 true 일 때, true, 아니면 false
		...
		String str2 = num3 < num4 ? "num4가 num3보다 크다" : "num4가 num3보다 작습니다.";
