...
// 자바에서는 단일 상속만을 지원!
// 한 클래스가 하나의 상위 클래스만 상속받을 수 있다.( 여러 개의 클래스로부터 상속받는 것은 허용X )
...
class Dog extends Animal {
	...
	// 자식 클래스에서 부모 클래스의 생성자를 호출하려면 'super'키워드를 사용
	// super는 부모 클래스를 가리킴.
	// super() 는 부모 클래스의 생성자를 호
...
//	public Dog() {
//		super(); //생성자를 내부에서 항상 첫 번째 줄에서 호출되어야 합니다.
//	}
 ...
 * 단, 항상 직접적으로 생성된 생성자를 필요로 하는 것은 X
 * 
 * 
 * 
 * 
