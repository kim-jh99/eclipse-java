...
public class A_Class_Auto_Type {
	...
	public static void main(String[] args) {
		// 클래스의 자동 타입 변환
		// : 개발자가 직접 명시 X, 자동으로 타입 변환이 일어남. (묵시적 형 변환)
		...
		Child c1 = new Child(); // c1 객체 생성 : Child 타입의 Child 객체
		
		Parent p2 = new Child(); // 1. 자동 타입 변환
		Parent p3 = c1; // 2. 자동 타입 변환 
		//Child c2 = p1;
		...
		// Child 타입의 Child 객체 c1 타입을 Parent로 변환해서 만든 p3는
		// 여전히 c1객체
		// 타입 변환 시 : 객체가 바뀌는 것 X, 객체는 보존되고 사용만 부모 객체처럼 사용
