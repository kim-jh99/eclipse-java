package Chapter01;
//데이터 타입
		// 각각의 데이터들은 자바에서 지정한 여러종류의 타입이 존재
		// 기본저긍로 정수형, 실수형, 문자형, 논리형이 존재
		// 추가적으로 참조형 데이터 타입
		
		// 일반적으로 특정한 데이터 타입으로 정의되 변수 혹은 상수는
		// 같은 데이터 타입읠 데이터로만 연산이 가능
...
public class Datatype {
	...
	public static void main(String[] args) {
		...
		byte byte1 = 127;
		//byte byte2 = 128; byte형은 127까지 가능
		
		/*
		 * 
		 * short type
		 * 
		 * 2byte ( -32,768 ~ 32,767) 크기의 데이터를 가질 수 있는 타입
		 */
		...
		int type;
		// 4byte (-2,147,483,648 ~ 2,147,483,647)크기의 데이터를 가질 수 있는 타입
		int int1 = 2147483647;
		//int int2 = 2147483648;
		
		//long type
		// 8byte (-2^63 ~ 2^63 - 1 ) 크기의 데이터를 가질 수 있는 정수형 데이터 타입
		// 정수타입의  리터러러 상수의 데이터 타입은 int 이기 때문에
		...
		//문자(단어X) 하나를 저장할 수 있는 공간
		// 한 문자를 표기할 땐 ''(따옴표)로 묶어서 표기
		char char1 = 'a';
		char char2 = 97;
